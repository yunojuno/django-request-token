    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_url', models.CharField(help_text='The target endpoint.', max_length=200)),
                ('expiration_time', models.DateTimeField(help_text='DateTime at which this token expires.', null=True, blank=True)),
                ('not_before_time', models.DateTimeField(help_text='DateTime before which this token is invalid.', null=True, blank=True)),
                ('data', models.TextField(help_text='Custom data (JSON) added to the default payload.', max_length=1000, blank=True)),
